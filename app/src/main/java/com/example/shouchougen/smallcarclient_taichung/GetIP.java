...
public class GetIP extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btname = pref.getString("btname", "98:D3:31:30:18:09");
        ipname = pref.getString("ipname", "140.116.164.19");
        //resolution_str = pref.getString("resolution", "15");
